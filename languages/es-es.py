...
'User %(id)s Logged-in': 'Usuario %(id)s inició sesión',
'User %(id)s Logged-out': 'Usuario %(id)s cerró sesión',
'User %(id)s Password changed': 'User %(id)s Password changed',
'User %(id)s Password reset': '',
'User %(id)s Profile updated': 'Usuario %(id)s actualizó sus datos',
